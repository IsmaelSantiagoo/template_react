    ...
    <div className='flex flex-col h-full items-center justify-center px-20'>
      <Card className='flex flex-col gap-6'>
        <CardHeader className='items-center gap-3'>
          ...
          <CardDescription className="text-center">Instale agora o app &quot;{import.meta.env.VITE_APP_NAME ?? 'Template App'}&quot; para acesso mais rápido, modo offline e sincronização automática. Leve sua produtividade no bolso.</CardDescription>
        </CardHeader>
        ...
        <CardFooter className='flex gap-2 justify-center'>
          ...
          <span className='text-sm text-muted-foreground'>Homologado e seguro pela {import.meta.env.VITE_APP_BRAND ?? 'App'}</span>
        </CardFooter>
      </Card>
    </div>
  )
