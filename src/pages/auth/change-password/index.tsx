import PasswordChangerDialog from "@/components/app/app-password-changer";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { useMobileHeader } from "@/hooks/mobile/use-mobile-header";
...
export default function ChangePasswordPage() {
  // ============ HOOKS ===========
  const { user } = useAuth();
  const { setShowBackButton, setPageDescription, setPageTitle, setShowLogoutButton } = useMobileHeader();
