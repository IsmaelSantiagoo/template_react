...
export const signUpSchema = (registering?: boolean) => z.object({
...
interface AuthContextType extends AuthState {
  ...
  changePassword: (changePasswordData: ResetPasswordSchema) => Promise<{ success: boolean; message: string }>
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const changePassword = async (changePasswordData: ResetPasswordSchema): Promise<{ success: boolean; message: string }> => {
    try {
